...
BasicBlock *translate::translate_stmt(NodePtr node, BasicBlock *current_bb, std::unordered_map<std::string, Value*>* symbol_table) {
    ...
    switch (node->node_type){
        ...
        case ND_AssignStmt: {
            ...
            addValue(symbol_table, ident_name, store_inst);
        ...
        case ND_IfStmt: { // two conditions
            ...
            if (else_stmt == nullptr) { // If (Expr) Stmt
                ...
                std::cout << "If (Expr) Stmt1 Else Stmt2" << std::endl;
        ...
        case ND_Decl: {
            ...
            for (auto child : vardeflist->children) {
                ...
                if (init_value != nullptr) {
                    ...
                    addValue(symbol_table, var_name, store_inst);
                }
            }
